...
public class WebAuthnDialectSpringTest {
    ...
    public void test() {
        ...
        springWebProcessingContextBuilder.setApplicationContextConfigLocation("classpath:net/sharplab/thymeleaf/dialect/processor/WebAuthnDialectSpringTest/applicationContext.xml");
        ...
        executor.execute("classpath:net/sharplab/thymeleaf/dialect/processor/WebAuthnDialectSpringTest/test.thtest");
    ...
    public void loadChallenge_null_test() {
        SpringWebProcessingContextBuilder springWebProcessingContextBuilder = new SpringWebProcessingContextBuilder();
        springWebProcessingContextBuilder.setApplicationContextConfigLocation("classpath:net/sharplab/thymeleaf/dialect/processor/WebAuthnDialectSpringTest/loadChallenge_null_applicationContext.xml");
